...
// testimonial images start here
export const alixa_mid = "/midAssets/alixa_mid.png"; // testimonial images
export const adriana_mid = "/midAssets/adriana_mid.png"; // testimonial images
export const ronald_mid = "/midAssets/ronald_mid.png";// testimonial images
export const abraham_mid = "/midAssets/abraham_mid.png"; // testimonial images

export const groot_mid = "/midAssets/groot_mid.jpg"; // testimonial images
export const superMan_mid = "/midAssets/superman_mid.jpg"; // testimonial images
export const stefan_mid = "/midAssets/Stefan_stefancik_mid.jpg";// testimonial images
export const Jake_mid = "/midAssets/Jake_Nackos_mid.jpg"; // testimonial images
// testimonial images end here
