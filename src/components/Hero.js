        ...
        <article className="hero_article _max_width_center _flex_box">
          <section className="hero_text _flex_box">
            <header>
              ...
              <p className="hero_text_header_p">Casablanca</p>
            </header>
            <div className="hero_div">
              <p>
                A family-owned restaurant with Mediterranean flavours, we
                celebrate traditional recipes by infusing them with a modern
                elegance, in the heart of Casablanca.{" "}
              </p>
              {screenWidth <= 500 && (
